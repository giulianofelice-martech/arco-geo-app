...
C) MAPA DE EVIDÊNCIAS E DEEP LINKS OBRIGATÓRIOS: O texto final PRECISA ter links externos para provar E-E-A-T, mas eles NÃO PODEM ser genéricos. Você deve vasculhar o contexto orgânico OU usar a sua própria base de conhecimento avançada para resgatar 2 a 3 DEEP LINKS REAIS (URLs completas com caminhos/slugs específicos, ex: "site.org/relatorios/2024/educacao-bilingue"). É ESTRITAMENTE PROIBIDO sugerir URLs de homepages (ex: "unesco.org", "mec.gov.br"). Liste esses deep links no briefing atrelados ao dado que eles comprovam.
