...
if 'current_page' not in st.session_state:
    ...
    mapa_reverso = {
        ...
        "monitor": "Monitor de GEO", "revisor": "Revisor & Adaptador", 
        "auditor": "Auditor de Artigos", "dashboard": "Dashboard"
    }
...
# ==========================================
nav_cols = st.columns([2, 2, 2, 2, 2, 2, 2]) # Adicionado mais um '2'
...
opcoes_menu = ["Gerador de Artigos", "BrandBook", "Monitor de GEO", "Revisor & Adaptador", "Auditor de Artigos", "Dashboard"]
